...
-- Data providers for the CPU/RAM etc widgets
jiffies = {}
function activecpu()
    local s = ""
...
function activeram()
   ...
   return string.format("amem: %.0f%%",(active/total)*100)
end
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        meminfo,     -- TODO just screen 1?
        cpuinfo,     -- TODO just screen 1?
        mytasklist[s],
